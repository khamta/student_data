...
- **ພິມ / ອອກລາຍງານ (พิมพ์/ออกรายงาน)** — แสดงรายงานฉบับเต็มจัดกลุ่มตาม
  ...
  นอกจากนี้ยังกดปุ่ม **📄 ອັບເດດລົງ Google Sheet** เพื่อสร้าง/อัปเดตแท็บ
  `ລາຍງານພິມ` ในไฟล์ Google ชีตของคุณโดยตรง ให้จัดวางเหมือนหน้ารายงานที่พิมพ์
  ทุกอย่าง (หัวกระดาษ, หัวตารางแบบรวมเซลล์, จัดกลุ่มตามสาขา, แถวสรุป,
  บรรทัดลงนาม) — เปิดชีตนี้ดูตรงๆ หรือแชร์ให้คนอื่นที่ไม่ได้เข้าเว็บแอปก็ได้
  ทำแบบเดียวกันได้จากเมนู **Extensions → ⁠ລະບົບຈັດການນັກສຶກສາ →
  ອັບເດດຊີດລາຍງານພິມ** ในชีตโดยตรงเช่นกัน หมายเหตุ: การตั้งค่าขนาดกระดาษ
  A4 แนวนอนตอนพิมพ์ต้องเลือกเองจากเมนู File → Print ของ Google ชีต เนื่องจาก
  Apps Script ไม่มี API ให้ตั้งค่านี้ล่วงหน้าให้อัตโนมัติ
